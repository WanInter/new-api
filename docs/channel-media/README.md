...
| Axmgc | `Axmgc` | `relay/channel/task/axmgc` | `seedance-2-720p-933` | `/v1/video/generations`（JSON） | Bearer | 固定 15 秒；`content` 支持 URL 或 Axmgc asset ID，不支持 multipart | `resource_list[].resource_url` 转 OpenAI Video URL |
