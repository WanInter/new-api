...
| Axmgc | `Axmgc` | `relay/channel/task/axmgc` | `seedance-2-720p-933` | 全部请求转发到 `/v1/video/generations/multipart` | Bearer | 固定 15 秒；JSON URL 素材安全下载后转 multipart，或直接上传图片/视频/音频 | `resource_list[].resource_url` 转 OpenAI Video URL |
