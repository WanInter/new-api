...
func TestCompleteSubscriptionOrderSyncsMetadataToCreatedTopUp(t *testing.T) {
	...
	if err := model.CompleteSubscriptionOrder(order.TradeNo, notifyPayload, model.PaymentProviderAlipayDirect, paymentMethodAlipayDirect); err != nil {
...
func TestCompleteSubscriptionOrderSyncsMetadataToExistingTopUp(t *testing.T) {
	...
	if err := model.CompleteSubscriptionOrder(order.TradeNo, "", model.PaymentProviderAlipayDirect, paymentMethodAlipayDirect); err != nil {
		t.Fatalf("failed to complete subscription order: %v", err)
	}
