...
var auditContentTemplates = map[string]string{
	...
	"model_pricing_rule.create": "Created model pricing rule ${id} for ${subject_type}:${subject_value} / ${model}",
	"model_pricing_rule.update": "Updated model pricing rule ${id} for ${subject_type}:${subject_value} / ${model}",
	"model_pricing_rule.delete": "Deleted model pricing rule ${id}",
	...
	"channel.routing_policy_update":           "Updated routing policy for ${model} (strict: ${strict}, revision ${revision})",
	"channel.routing_capability_update":       "Updated routing capability for channel ${channel_id} / ${upstream_model} (revision ${revision})",
	"channel.routing_capability_delete":       "Deleted routing capability for channel ${channel_id} / ${upstream_model} (revision ${revision})",
