...
type ChannelOtherSettings struct {
	...
	// VideoRouting is retained only to read and re-save legacy channel settings.
	// Effective video capabilities are configured through exact channel-model rules.
