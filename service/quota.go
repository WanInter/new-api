...
func PreWssConsumeQuota(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, usage *dto.RealtimeUsage) error {
	...
	actualGroupRatio := ratioInfo.GroupRatio
	if !ratioInfo.Resolved {
		// Realtime requests normally have resolved PriceData. Preserve the legacy
		// lookup only for callers that did not initialize it; zero is a valid
		// configured multiplier and must not trigger this fallback.
