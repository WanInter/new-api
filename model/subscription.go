...
func (o *SubscriptionOrder) GetPaymentProvider() string {
	if o == nil {
		return ""
	}
	...
	case PaymentMethodAlipayDirect:
		return PaymentProviderAlipayDirect
	case "":
		return ""
	default:
...
func CompleteSubscriptionOrder(tradeNo string, providerPayload string, expectedPaymentProvider string, actualPaymentMethod string) error {
	...
	err := DB.Transaction(func(tx *gorm.DB) error {
		...
		if expectedPaymentProvider != "" && order.GetPaymentProvider() != expectedPaymentProvider {
...
func upsertSubscriptionTopUpTx(tx *gorm.DB, order *SubscriptionOrder) error {
	...
	if strings.TrimSpace(order.ProviderPayload) != "" {
