...
import (
	...
	taskaxmgc "github.com/QuantumNous/new-api/relay/channel/task/axmgc"
	...
	taskyoboxcorp "github.com/QuantumNous/new-api/relay/channel/task/yoboxcorp"
...
func GetTaskAdaptor(platform constant.TaskPlatform) channel.TaskAdaptor {
	...
	if channelType, err := strconv.ParseInt(string(platform), 10, 64); err == nil {
		...
		case constant.ChannelTypeJimengDimensio:
			return &taskjimengdimensio.TaskAdaptor{}
		case constant.ChannelTypeXingheVideo:
		...
		case constant.ChannelTypeYoboxCorp:
			return &taskyoboxcorp.TaskAdaptor{}
