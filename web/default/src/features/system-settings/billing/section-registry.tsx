...
const getModelDefaults = (settings: BillingSettings) => ({
  ...
  BillingSchema: settings['billing_setting.billing_schema'],
})
    ...
    build: (settings: BillingSettings) => (
      <PaymentSettingsSection
        defaultValues={{
          ...
          AlipayPayMode: settings.AlipayPayMode,
          ...
          AlipayOrderDescription: settings.AlipayOrderDescription,
          ...
          WeChatPayUnitPrice: settings.WeChatPayUnitPrice,
          WeChatPayMinTopUp: settings.WeChatPayMinTopUp,
          WeChatPayNotifyUrl: settings.WeChatPayNotifyUrl,
          WeChatPayOrderDescription: settings.WeChatPayOrderDescription,
